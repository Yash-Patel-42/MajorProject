const apikey = `439e0c6ec125f26d9ea096a61d4e49ac`;
...
document.getElementById('search').addEventListener('click',()=>{
    ...
    // const weather_data = fetch(`${urlsearch}`).then(response=> response.json());
    // document.getElementById('humidity').innerHTML = `${weather_data.main.humidity}%`;
    // document.getElementById('windspeed').innerHTML = `${weather_data.main.wind.speed}Km/H`;
